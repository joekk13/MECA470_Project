...
<center>
   <h4> <a href="https://www.csuchico.edu/">California State University Chico</a></h4>
   <h4> <a href="https://www.csuchico.edu/mmem/">Department of Mechanical and Mechatronic Engineering and Advanced Manufacturing</a></h4> 
   <h4> <a href="Syllabus.pdf" target="_blank">MECA 470 - Introduction to Robotics</a></h4> 
...
After the system being initiated, a controller has been created for this system, including 17 knobs, each for a specific Degree of Freedom (GIF at the beginning of this README file). To do so, a code has been written in Coppelia. Since thi code is long because of the system's DoFs, it is not going to be printed below (it is located in CoppeliaCodes/Controller). In addition, the file that has the whole Coppelia System is located in CoppeliaCodes/Timber_Controller.ttt .<br> <p>
